...
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+M(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}};function V(e,t){return B.parse(e,t)}V.options=V.setOptions=function(e){return B.setOptions(e),V.defaults=B.defaults,n(V.defaults),V},V.getDefaults=e,V.defaults=t,V.use=function(...e){return B.use(...e),V.defaults=B.defaults,n(V.defaults),V},V.walkTokens=function(e,t){return B.walkTokens(e,t)},V.parseInline=B.parseInline,V.Parser=R,V.parser=R.parse,V.Renderer=I,V.TextRenderer=L,V.Lexer=F,V.lexer=F.lex,V.Tokenizer=P,V.Hooks=z,V.parse=V,V.options,V.setOptions,V.use,V.walkTokens,V.parseInline,R.parse,F.lex;var H=class{constructor(e,t){this.editor=e,this.defaultText=`${t} text`,this.button=this.createButton(),this.title=t}createButton(e){let t=document.createElement(`button`),n=this.title?`${this.title.replace(/ /g,`-`)}-btn`.toLowerCase():``;t.innerHTML=e;let r=t.querySelector(`svg`);if(r&&r.setAttribute(`aria-hidden`,`true`),t.type=`button`,t.title=this.title,t.className=`markdown-btn ${n} fj:me-btn fj:me-btn-xs fj:me-btn-square fj:me-btn-ghost`,t.addEventListener(`click`,e=>this.applySyntax(e)),n==`preview-btn`){let e=document.createElement(`div`);return e.className=`fj:me-surface fj:me-surface-outline fj:border-base-soft fj:border-0 fj:border-l fj:sticky fj:-right-2 fj:px-1.5`,e.appendChild(t),e}return t}},Ue=class extends H{constructor(e){super(e,`Bold`),this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.usertextarea,{selectionStart:t,selectionEnd:n}=e,r=e.value,i=r.substring(t,n),a=``,o=0;if(i.startsWith(`***`)&&i.endsWith(`***`))a=`*`+i.slice(3,-3)+`*`;else if(i.startsWith(`**`)&&i.endsWith(`**`))a=i.slice(2,-2);else if(r.substring(t-3,t)===`***`&&r.substring(n,n+3)===`***`){e.setSelectionRange(t-3,n+3),this.editor.insertText(`*${i}*`,1,1);return}else if(r.substring(t-2,t)===`**`&&r.substring(n,n+2)===`**`&&r[t-3]!==`*`&&r[n+2]!==`*`){e.setSelectionRange(t-2,n+2),this.editor.insertText(i,0,0);return}else a=`**${i||`Bold text`}**`,i||(o=2);this.editor.insertText(a,o,o)}},We=class extends H{constructor(e){super(e,`Italic`),this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.usertextarea,{selectionStart:t,selectionEnd:n}=e,r=e.value,i=r.substring(t,n),a=``,o=0;if(i.startsWith(`***`)&&i.endsWith(`***`))a=`**`+i.slice(3,-3)+`**`;else if(i.startsWith(`*`)&&i.endsWith(`*`)&&!i.startsWith(`**`))a=i.slice(1,-1);else if(r.substring(t-3,t)===`***`&&r.substring(n,n+3)===`***`){e.setSelectionRange(t-3,n+3),this.editor.insertText(`**${i}**`,2,2);return}else if(r[t-1]===`*`&&r[n]===`*`&&r[t-2]!==`*`&&r[n+1]!==`*`){e.setSelectionRange(t-1,n+1),this.editor.insertText(i,0,0);return}else a=`*${i||`Italic text`}*`,i||(o=1);this.editor.insertText(a,o,o)}},Ge=class extends H{constructor(e){super(e,`Strikethrough`),this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.usertextarea,{selectionStart:t,selectionEnd:n}=e,r=e.value,i=r.substring(t,n),a=``,o=0;if(i.startsWith(`~~`)&&i.endsWith(`~~`))a=i.slice(2,-2);else if(r.substring(t-2,t)===`~~`&&r.substring(n,n+2)===`~~`){e.setSelectionRange(t-2,n+2),this.editor.insertText(i,0,0);return}else a=`~~${i||`Strikethrough text`}~~`,o=2;this.editor.insertText(a,o,o)}},Ke=class extends H{constructor(e){super(e,`Unordered list`),this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.usertextarea,{selectionStart:t,selectionEnd:n}=e,r=e.value,i=r.substring(t,n),a=``,o=0;if(i.startsWith(`- `))a=i.slice(2);else if(r.substring(t-2,t)===`- `){e.setSelectionRange(t-2,n),this.editor.insertText(i,0,0);return}else a=`- ${i||`Unordered list`}`,o=2;this.editor.insertText(a,o)}},qe=class extends H{constructor(e){super(e,`Ordered list`),this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.usertextarea,{selectionStart:t,selectionEnd:n}=e,r=e.value,i=r.substring(t,n),a=``,o=0;if(i.startsWith(`1. `))a=i.slice(3);else if(r.substring(t-3,t)===`1. `){e.setSelectionRange(t-3,n),this.editor.insertText(i,0,0);return}else a=`1. ${i||`Ordered list`}`,o=3;this.editor.insertText(a,o)}},Je=class extends H{constructor(e){super(e,`Preview`),this.preview=!0,this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.usertextarea,{selectionStart:t,selectionEnd:n}=e,r=e.value,i=r.substring(t,n),a=`- [x] `,o=`- [ ] `,s=``,c=0;if(i.startsWith(a)||i.startsWith(o))s=i.slice(6);else{let l=r.substring(t-6,t);if(l===a||l===o){e.setSelectionRange(t-6,n),this.editor.insertText(i,0,0);return}s=`${a}${i||`Check list`}`,c=6}this.editor.insertText(s,c)}},Xe=class extends H{constructor(e){super(e,`Blockquote`),this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.usertextarea,{selectionStart:t,selectionEnd:n}=e,r=e.value,i=r.substring(t,n),a=``,o=0;if(i.startsWith(`>`))a=i.slice(1);else if(r.substring(t-1,t)===`>`){e.setSelectionRange(t-1,n),this.editor.insertText(i,0,0);return}else a=`>${i||`Blockquote text`}`,i||(o=1);this.editor.insertText(a,o)}};function Ze(e,t,n,r=``){let i=e.target.closest(`.markdown-editor-wrapper`);i.querySelector(`.markdown-modal`)&&i.querySelector(`.markdown-modal`).remove();let a=`
    ...
    `;i.querySelector(`.markdown-modal`)||i.insertAdjacentHTML(`beforeend`,a);let o=i.querySelector(`.markdown-modal`);return o.addEventListener(`close`,()=>o.remove()),o.showModal(),o}var Qe=class extends H{constructor(e){super(e,`Link`),this.button=this.createButton(`
        ...
        `)}applySyntax(e){let t=this.editor,n=t.usertextarea,{selectionStart:r,selectionEnd:i}=n,a=n.value.substring(r,i),o=/\[([^\]]+)\]\(([^)]+)\)/;if(a&&o.test(a)){let e=a.match(o)[1];n.setRangeText(e,r,i,`select`)}else{let n=Ze(e,`fj:max-w-sm`,`
                ...
                </form>`,`Link`);n.querySelector(`.submit-link`).addEventListener(`click`,function(e){e.preventDefault();let r=n.querySelector(`.link-input`),i=n.querySelector(`.link-text-input`);if(!r.validity.valid)r.reportValidity();else if(!i.validity.valid)i.reportValidity();else{let e=r.value,o=i.value;o==``&&(o=`Link Text`);let s=``;s=a?`[${a}](${e})`:`[${o}](${e})`,t.insertText(s),r.value=``,i.value=``,n.close()}})}}},$e=class extends H{constructor(e){super(e,`Heading`),this.button=this.createButton(`
        ...
        `)}createButton(e){let t=`heading-popover-${Math.random().toString(36).slice(2,7)}`,n=document.createElement(`button`);n.innerHTML=e;let r=n.querySelector(`svg`);r&&r.setAttribute(`aria-hidden`,`true`),n.type=`button`,n.title=`Heading`,n.className=`markdown-btn heading-btn fj:me-btn fj:me-btn-xs fj:me-btn-square fj:me-btn-ghost fj:me-popover-toggle`,n.setAttribute(`popovertarget`,t);let i=document.createElement(`div`);i.id=t,i.tabIndex=0,i.className=`fj:me-popover-content`,i.setAttribute(`popover`,``);let a=document.createElement(`ul`);a.className=`fj:me-menu`;let o=[`fj:me-heading-xl`,`fj:me-heading-lg`,`fj:me-heading-md`,`fj:me-heading-sm`,`fj:me-heading-xs`,`fj:me-heading-xs`];for(let e=1;e<=6;e++){let t=document.createElement(`li`),n=document.createElement(`a`);n.className=`fj:me-menu-item ${o[e-1]}`,n.textContent=`Heading ${e}`,n.addEventListener(`click`,()=>{this.applyHeading(e),i.hidePopover()}),t.appendChild(n),a.appendChild(t)}i.appendChild(a);let s=document.createElement(`div`);return s.className=`fj:me-popover`,s.appendChild(n),s.appendChild(i),s}applyHeading(e){let t=this.editor.usertextarea,{selectionStart:n,selectionEnd:r}=t,i=t.value,a=i.lastIndexOf(`
`,n-1)+1,o=i.indexOf(`
`,r),s=o===-1?i.length:o,c=i.substring(a,s),l=(c.match(/^(#+)\s/)||[])[1],u=c.replace(/^#+\s*/,``),d=`${`#`.repeat(e)} `,f=l&&l.length===e?u||`Heading`:u?`${d}${u}`:`${d}Heading`;t.value=`${i.substring(0,a)}${f}${i.substring(s)}`,t.focus();let p=a+(f===u||f===`Heading`?0:d.length),m=a+f.length;t.setSelectionRange(p,m),this.editor.scrollToView(),this.editor.render()}applySyntax(){}},et=class extends H{constructor(e,t={}){super(e,`Image link`),this.config=t,this.fileInputConfig=t.fileInput||!1,this.altInputConfig=t.altInput===void 0?{required:!0}:t.altInput,this.button=this.createButton(`
        ...
        `)}applySyntax(e){let t=this.editor,n=t.usertextarea,{selectionStart:r,selectionEnd:i}=n,a=n.value.substring(r,i),o=this.fileInputConfig.accept?this.fileInputConfig.accept.map(e=>`image/${e}`).join(`,`):`image/*`,s=typeof this.altInputConfig==`boolean`?this.altInputConfig:this.altInputConfig.required!==!1,c=this.fileInputConfig.uploadUrl||null,l=this.fileInputConfig.params||{},u=/!\[([^\]]*)\]\(([^)]+)\)/;if(a&&u.test(a)){let e=a.match(u);n.setRangeText(e[1],r,i,`select`);return}let d=``;this.fileInputConfig&&(d=`
            ...
            </div>`,`Image`),p=f.querySelector(`.submit-img-link`);p.addEventListener(`click`,async e=>{e.preventDefault();let n=f.querySelector(`.img-file-input`),r=f.querySelector(`.img-link-input`),i=f.querySelector(`.img-link-alt-input`),o=n?.files[0];if(o&&(r.required=!1),s&&!i.validity.valid){i.reportValidity(),o&&(r.required=!0);return}if(!o&&!r.validity.valid){r.reportValidity();return}if(o&&c){let e=n.files[0];p.disabled=!0,p.textContent=`Uploading...`;let t=new FormData;t.append(`image_file`,e),t.append(`image_alt`,i.value),Object.keys(l).forEach(e=>{t.append(e,l[e])});try{let e=await(await fetch(c,{method:`POST`,body:t})).json();if(e.success&&e.image_path)r.value=e.image_path,e.image_alt&&(i.value=e.image_alt);else{alert(e.error||e.message||`Image upload failed.`),p.disabled=!1,p.textContent=`Apply`,r.required=!0;return}}catch{alert(`Upload failed.`),p.disabled=!1,p.textContent=`Apply`,r.required=!0;return}p.disabled=!1,p.textContent=`Apply`}let u=r.value,d=i.value||``,m=a?`![${a}](${u})`:`![${d}](${u})`;t.insertText(m),f.close()})}},tt=class extends H{constructor(e){super(e,`Undo`),this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.undoRedoManager;e&&e.undo()}},nt=class extends H{constructor(e){super(e,`Redo`),this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.undoRedoManager;e&&e.redo()}},rt=class extends H{constructor(e){super(e,`Indent`),this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.indentManager;e&&(e.indent(),this.editor.render())}},it=class extends H{constructor(e){super(e,`Outdent`),this.button=this.createButton(`
        ...
        `)}applySyntax(e){let t=this.editor.indentManager;t&&(t.outdent(),this.editor.render())}},at=class extends H{constructor(e){super(e,`Code`),this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.usertextarea,{selectionStart:t,selectionEnd:n}=e,r=e.value,i=r.substring(t,n);if(i.startsWith("`")&&i.endsWith("`")){this.editor.insertText(i.slice(1,-1),0,0);return}if(r[t-1]==="`"&&r[n]==="`"){e.setSelectionRange(t-1,n+1),this.editor.insertText(i,0,0);return}let a=`\`${i||`code`}\``;this.editor.insertText(a,1,1)}},ot=class extends H{constructor(e){super(e,`Code Block`),this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.usertextarea,{selectionStart:t,selectionEnd:n}=e,r=e.value.substring(t,n);if(r.startsWith("```")&&r.endsWith("```")&&r.length>6){let e=r.replace(/^```\w*\n?/,``).replace(/\n?```$/,``);this.editor.insertText(e,0,0);return}let i=`\`\`\`\n${r||`code`}\n\`\`\``;this.editor.insertText(i,4,4)}},st=class extends H{constructor(e){super(e,`Horizontal Rule`),this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.usertextarea,{selectionStart:t}=e,n=e.value,r=t===0||n[t-1]===`
`?`---
`:`

---
`;this.editor.insertText(r,r.length,0)}},ct=class extends H{constructor(e){super(e,`Table`),this.button=this.createButton(`
        ...
        `)}applySyntax(){let e=this.editor.usertextarea,{selectionStart:t}=e,n=e.value,r=`| Column 1 | Column 2 | Column 3 |
| --- | --- | --- |
| Cell | Cell | Cell |
| Cell | Cell | Cell |`,i=t===0||n[t-1]===`
`?r:`\n${r}`;this.editor.insertText(i,i.length,0)}},lt=class{constructor(e,t){this.editor=e,this.options=t,this.toolbar=document.createElement(`div`),this.toolbar.className=`toolbar fj:me-surface fj:me-surface-outline fj:border-base-soft fj:border-0 fj:border-b fj:flex fj:gap-x-1 fj:p-1.5 fj:overflow-x-auto`,this.toolbar.setAttribute(`role`,`toolbar`),this.toolbar.setAttribute(`aria-label`,`Editor toolbar`),this.init()}init(){let e={heading:$e,ul:Ke,ol:qe,checklist:Ye,bold:Ue,italic:We,strikethrough:Ge,blockquote:Xe,code:at,codeblock:ot,hr:st,table:ct,link:Qe,image:et,undo:tt,redo:nt,indent:rt,outdent:it};if(this.options.forEach(t=>{let n,r;if(typeof t==`string`)n=e[t];else if(typeof t==`object`){let i=Object.keys(t)[0];r=t[i],n=e[i]}if(n){let e=new n(this.editor,r);this.toolbar.appendChild(e.button)}}),this.options.includes(`preview`)){let e=new Je(this.editor);this.toolbar.appendChild(e.button)}this.editor.editorContainer.insertBefore(this.toolbar,this.editor.markdownEditorDiv)}},ut=class{constructor(e){this.previewContainer=document.createElement(`div`),this.previewContainer.className=`preview-wrapper fj:p-2 fj:hidden fj:me-surface fj:me-surface-outline fj:border-base-soft fj:border-0 fj:border-l`,this.previewContainer.setAttribute(`role`,`region`),this.previewContainer.setAttribute(`aria-label`,`Preview`),this.previewContent=document.createElement(`div`),this.previewContent.className=`preview-content fj:prose fj:prose-sm fj:md:prose-base fj:me-prose-frutjam fj:p-1.5 fj:overflow-y-auto fj:h-full fj:max-w-full`,this.previewContainer.appendChild(this.previewContent),e.appendChild(this.previewContainer)}getPreviewContent(){return this.previewContent}},dt=class{constructor(e,t={}){this.options=t,this.footer=document.createElement(`div`),this.footer.className=`editor-footer fj:me-surface fj:me-surface-outline fj:border-base-soft fj:border-0 fj:border-t fj:flex fj:justify-between fj:items-center fj:px-3 fj:py-1 fj:text-xs fj:opacity-60 fj:select-none`,this.footer.setAttribute(`aria-hidden`,`true`),this.positionEl=document.createElement(`span`),this.charsEl=document.createElement(`span`),(this.options.line||this.options.col)&&this.footer.appendChild(this.positionEl),this.options.chars&&this.footer.appendChild(this.charsEl),e.appendChild(this.footer)}update(e){let t=e.value,n=e.selectionStart??0;if(this.options.line||this.options.col){let e=t.substring(0,n).split(`
`),r=[];this.options.line&&r.push(`Ln ${e.length}`),this.options.col&&r.push(`Col ${e[e.length-1].length+1}`),this.positionEl.textContent=r.join(`, `)}this.options.chars&&(this.charsEl.textContent=`${t.length.toLocaleString()} chars`)}},U=class{diff(e,t,n={}){let r;typeof n==`function`?(r=n,n={}):`callback`in n&&(r=n.callback);let i=this.castInput(e,n),a=this.castInput(t,n),o=this.removeEmpty(this.tokenize(i,n)),s=this.removeEmpty(this.tokenize(a,n));return this.diffWithOptionsObj(o,s,n,r)}diffWithOptionsObj(e,t,n,r){let i=e=>{if(e=this.postProcess(e,n),r){setTimeout(function(){r(e)},0);return}else return e},a=t.length,o=e.length,s=1,c=a+o;n.maxEditLength!=null&&(c=Math.min(c,n.maxEditLength));let l=n.timeout??1/0,u=Date.now()+l,d=[{oldPos:-1,lastComponent:void 0}],f=this.extractCommon(d[0],t,e,0,n);if(d[0].oldPos+1>=o&&f+1>=a)return i(this.buildValues(d[0].lastComponent,t,e));let p=-1/0,m=1/0,h=()=>{for(let r=Math.max(p,-s);r<=Math.min(m,s);r+=2){let s,c=d[r-1],l=d[r+1];c&&(d[r-1]=void 0);let u=!1;if(l){let e=l.oldPos-r;u=l&&0<=e&&e<a}let h=c&&c.oldPos+1<o;if(!u&&!h){d[r]=void 0;continue}if(s=!h||u&&c.oldPos<l.oldPos?this.addToPath(l,!0,!1,0,n):this.addToPath(c,!1,!0,1,n),f=this.extractCommon(s,t,e,r,n),s.oldPos+1>=o&&f+1>=a)return i(this.buildValues(s.lastComponent,t,e))||!0;d[r]=s,s.oldPos+1>=o&&(m=Math.min(m,r-1)),f+1>=a&&(p=Math.max(p,r+1))}s++};if(r)(function e(){setTimeout(function(){if(s>c||Date.now()>u)return r(void 0);h()||e()},0)})();else for(;s<=c&&Date.now()<=u;){let e=h();if(e)return e}}addToPath(e,t,n,r,i){let a=e.lastComponent;return a&&!i.oneChangePerToken&&a.added===t&&a.removed===n?{oldPos:e.oldPos+r,lastComponent:{count:a.count+1,added:t,removed:n,previousComponent:a.previousComponent}}:{oldPos:e.oldPos+r,lastComponent:{count:1,added:t,removed:n,previousComponent:a}}}extractCommon(e,t,n,r,i){let a=t.length,o=n.length,s=e.oldPos,c=s-r,l=0;for(;c+1<a&&s+1<o&&this.equals(n[s+1],t[c+1],i);)c++,s++,l++,i.oneChangePerToken&&(e.lastComponent={count:1,previousComponent:e.lastComponent,added:!1,removed:!1});return l&&!i.oneChangePerToken&&(e.lastComponent={count:l,previousComponent:e.lastComponent,added:!1,removed:!1}),e.oldPos=s,c}equals(e,t,n){return n.comparator?n.comparator(e,t):e===t||!!n.ignoreCase&&e.toLowerCase()===t.toLowerCase()}removeEmpty(e){let t=[];for(let n=0;n<e.length;n++)e[n]&&t.push(e[n]);return t}castInput(e,t){return e}tokenize(e,t){return Array.from(e)}join(e){return e.join(``)}postProcess(e,t){return e}get useLongestToken(){return!1}buildValues(e,t,n){let r=[],i;for(;e;)r.push(e),i=e.previousComponent,delete e.previousComponent,e=i;r.reverse();let a=r.length,o=0,s=0,c=0;for(;o<a;o++){let e=r[o];if(e.removed)e.value=this.join(n.slice(c,c+e.count)),c+=e.count;else{if(!e.added&&this.useLongestToken){let r=t.slice(s,s+e.count);r=r.map(function(e,t){let r=n[c+t];return r.length>e.length?r:e}),e.value=this.join(r)}else e.value=this.join(t.slice(s,s+e.count));s+=e.count,e.added||(c+=e.count)}}return r}},ft=new class extends U{};function pt(e,t,n){return ft.diff(e,t,n)}function mt(e,t){let n;for(n=0;n<e.length&&n<t.length;n++)if(e[n]!=t[n])return e.slice(0,n);return e.slice(0,n)}function ht(e,t){let n;if(!e||!t||e[e.length-1]!=t[t.length-1])return``;for(n=0;n<e.length&&n<t.length;n++)if(e[e.length-(n+1)]!=t[t.length-(n+1)])return e.slice(-n);return e.slice(-n)}function W(e,t,n){if(e.slice(0,t.length)!=t)throw Error(`string ${JSON.stringify(e)} doesn't start with prefix ${JSON.stringify(t)}; this is a bug`);return n+e.slice(t.length)}function G(e,t,n){if(!t)return e+n;if(e.slice(-t.length)!=t)throw Error(`string ${JSON.stringify(e)} doesn't end with suffix ${JSON.stringify(t)}; this is a bug`);return e.slice(0,-t.length)+n}function K(e,t){return W(e,t,``)}function q(e,t){return G(e,t,``)}function gt(e,t){return t.slice(0,_t(e,t))}function _t(e,t){let n=0;e.length>t.length&&(n=e.length-t.length);let r=t.length;e.length<t.length&&(r=e.length);let i=Array(r),a=0;i[0]=0;for(let e=1;e<r;e++){for(t[e]==t[a]?i[e]=i[a]:i[e]=a;a>0&&t[e]!=t[a];)a=i[a];t[e]==t[a]&&a++}a=0;for(let r=n;r<e.length;r++){for(;a>0&&e[r]!=t[a];)a=i[a];e[r]==t[a]&&a++}return a}function vt(e,t){let n=[];for(let r of Array.from(t.segment(e))){let e=r.segment;n.length&&/\s/.test(n[n.length-1])&&/\s/.test(e)?n[n.length-1]+=e:n.push(e)}return n}function J(e,t){if(t)return X(e,t)[1];let n;for(n=e.length-1;n>=0&&e[n].match(/\s/);n--);return e.substring(n+1)}function Y(e,t){if(t)return X(e,t)[0];let n=e.match(/^\s*/);return n?n[0]:``}function X(e,t){if(!t)return[Y(e),J(e)];if(t.resolvedOptions().granularity!=`word`)throw Error(`The segmenter passed must have a granularity of "word"`);let n=vt(e,t),r=n[0],i=n[n.length-1];return[/\s/.test(r)?r:``,/\s/.test(i)?i:``]}var Z=`a-zA-Z0-9_\\u{AD}\\u{C0}-\\u{D6}\\u{D8}-\\u{F6}\\u{F8}-\\u{2C6}\\u{2C8}-\\u{2D7}\\u{2DE}-\\u{2FF}\\u{1E00}-\\u{1EFF}`,yt=RegExp(`[${Z}]+|\\s+|[^${Z}]`,`ug`);new class extends U{equals(e,t,n){return n.ignoreCase&&(e=e.toLowerCase(),t=t.toLowerCase()),e.trim()===t.trim()}tokenize(e,t={}){let n;if(t.intlSegmenter){let r=t.intlSegmenter;if(r.resolvedOptions().granularity!=`word`)throw Error(`The segmenter passed must have a granularity of "word"`);n=vt(e,r)}else n=e.match(yt)||[];let r=[],i=null;return n.forEach(e=>{/\s/.test(e)?i==null?r.push(e):r.push(r.pop()+e):i!=null&&/\s/.test(i)?r[r.length-1]==i?r.push(r.pop()+e):r.push(i+e):r.push(e),i=e}),r}join(e){return e.map((e,t)=>t==0?e:e.replace(/^\s+/,``)).join(``)}postProcess(e,t){if(!e||t.oneChangePerToken)return e;let n=null,r=null,i=null;return e.forEach(e=>{e.added?r=e:e.removed?i=e:((r||i)&&bt(n,i,r,e,t.intlSegmenter),n=e,r=null,i=null)}),(r||i)&&bt(n,i,r,null,t.intlSegmenter),e}};function bt(e,t,n,r,i){if(t&&n){let[a,o]=X(t.value,i),[s,c]=X(n.value,i);if(e){let r=mt(a,s);e.value=G(e.value,s,r),t.value=K(t.value,r),n.value=K(n.value,r)}if(r){let e=ht(o,c);r.value=W(r.value,c,e),t.value=q(t.value,e),n.value=q(n.value,e)}}else if(n){if(e){let e=Y(n.value,i);n.value=n.value.substring(e.length)}if(r){let e=Y(r.value,i);r.value=r.value.substring(e.length)}}else if(e&&r){let n=Y(r.value,i),[a,o]=X(t.value,i),s=mt(n,a);t.value=K(t.value,s);let c=ht(K(n,s),o);t.value=q(t.value,c),r.value=W(r.value,n,c),e.value=G(e.value,n,n.slice(0,n.length-c.length))}else if(r){let e=Y(r.value,i),n=gt(J(t.value,i),e);t.value=q(t.value,n)}else if(e){let n=gt(J(e.value,i),Y(t.value,i));t.value=K(t.value,n)}}new class extends U{tokenize(e){let t=RegExp(`(\\r?\\n)|[${Z}]+|[^\\S\\n\\r]+|[^${Z}]`,`ug`);return e.match(t)||[]}},new class extends U{constructor(){super(...arguments),this.tokenize=Q}equals(e,t,n){return n.ignoreWhitespace?((!n.newlineIsToken||!e.includes(`
`))&&(e=e.trim()),(!n.newlineIsToken||!t.includes(`
`))&&(t=t.trim())):n.ignoreNewlineAtEof&&!n.newlineIsToken&&(e.endsWith(`
`)&&(e=e.slice(0,-1)),t.endsWith(`
`)&&(t=t.slice(0,-1))),super.equals(e,t,n)}};function Q(e,t){t.stripTrailingCr&&(e=e.replace(/\r\n/g,`
`));let n=[],r=e.split(/(\n|\r\n)/);r[r.length-1]||r.pop();for(let e=0;e<r.length;e++){let i=r[e];e%2&&!t.newlineIsToken?n[n.length-1]+=i:n.push(i)}return n}function xt(e){return e==`.`||e==`!`||e==`?`}new class extends U{tokenize(e){let t=[],n=0;for(let r=0;r<e.length;r++){if(r==e.length-1){t.push(e.slice(n));break}if(xt(e[r])&&e[r+1].match(/\s/)){for(t.push(e.slice(n,r+1)),r=n=r+1;e[r+1]?.match(/\s/);)r++;t.push(e.slice(n,r+1)),n=r+1}}return t}},new class extends U{tokenize(e){return e.split(/([{}:;,]|\s+)/)}},new class extends U{constructor(){super(...arguments),this.tokenize=Q}get useLongestToken(){return!0}castInput(e,t){let{undefinedReplacement:n,stringifyReplacer:r=(e,t)=>t===void 0?n:t}=t;return typeof e==`string`?e:JSON.stringify($(e,null,null,r),null,`  `)}equals(e,t,n){return super.equals(e.replace(/,([\r\n])/g,`$1`),t.replace(/,([\r\n])/g,`$1`),n)}};function $(e,t,n,r,i){t||=[],n||=[],r&&(e=r(i===void 0?``:i,e));let a;for(a=0;a<t.length;a+=1)if(t[a]===e)return n[a];let o;if(Object.prototype.toString.call(e)===`[object Array]`){for(t.push(e),o=Array(e.length),n.push(o),a=0;a<e.length;a+=1)o[a]=$(e[a],t,n,r,String(a));return t.pop(),n.pop(),o}if(e&&e.toJSON&&(e=e.toJSON()),typeof e==`object`&&e){t.push(e),o={},n.push(o);let i=[],s;for(s in e)Object.prototype.hasOwnProperty.call(e,s)&&i.push(s);for(i.sort(),a=0;a<i.length;a+=1)s=i[a],o[s]=$(e[s],t,n,r,s);t.pop(),n.pop()}else o=e;return o}new class extends U{tokenize(e){return e.slice()}join(e){return e}removeEmpty(e){return e}};var St=class{constructor(e){this.editor=e,this.textarea=e.usertextarea,this.undoStack=[],this.redoStack=[],this.lastValue=this.textarea.value,this.lastSelection={selectionStart:this.textarea.selectionStart,selectionEnd:this.textarea.selectionEnd},this.debounceDelay=1e3,this.maxStackSize=100,this._debounceTimer=null,this._bindEvents()}_bindEvents(){this.textarea.addEventListener(`keydown`,e=>this._onKeyDown(e)),this.textarea.addEventListener(`select`,()=>this._updateLastSelection()),this.textarea.addEventListener(`mousedown`,()=>{setTimeout(()=>this._updateLastSelection(),0)}),this.textarea.addEventListener(`beforeinput`,e=>{e.inputType===`historyUndo`?(e.preventDefault(),this.undo()):e.inputType===`historyRedo`&&(e.preventDefault(),this.redo())}),this.textarea.addEventListener(`input`,e=>this._onInput(e)),this.textarea.addEventListener(`paste`,()=>this._saveState()),this.textarea.addEventListener(`blur`,()=>this._saveState())}_updateLastSelection(){this.lastSelection={selectionStart:this.textarea.selectionStart,selectionEnd:this.textarea.selectionEnd}}_onKeyDown(e){let t=e.metaKey||e.ctrlKey,n=e.key.toLowerCase()===`z`,r=e.key.toLowerCase()===`y`,i=e.shiftKey,a=this.textarea.selectionStart!==this.textarea.selectionEnd,o=e.key===`Backspace`||e.key===`Delete`||e.key===`Enter`;a&&(e.key.length===1||o)&&this._saveState(),(t||o)&&this._saveState(),t&&n&&!i?(e.preventDefault(),this.undo()):t&&(i&&n||!e.metaKey&&r)&&(e.preventDefault(),this.redo())}_onInput(e){clearTimeout(this._debounceTimer);let t=this.textarea.value[this.textarea.selectionStart-1];t&&/[\s.,;:!?()\[\]{}'"`~]/.test(t)?this._saveState():this._debounceTimer=setTimeout(()=>this._saveState(),this.debounceDelay)}_saveState(){let e=this.textarea.value||``;if(e===this.lastValue)return;clearTimeout(this._debounceTimer);let t=pt(this.lastValue,e);this.undoStack.push({diff:t,selection:{...this.lastSelection}}),this.undoStack.length>this.maxStackSize&&this.undoStack.shift(),this.lastValue=e,this._updateLastSelection(),this.redoStack=[]}undo(){if(this.undoStack.length===0)return;let e=this.undoStack.pop(),t=this._revertDiff(this.lastValue,e.diff);this.redoStack.push({diff:e.diff,selection:{selectionStart:this.textarea.selectionStart,selectionEnd:this.textarea.selectionEnd}}),this._restoreState(t,e.selection)}redo(){if(this.redoStack.length===0)return;let e=this.redoStack.pop(),t=this._applyDiff(this.lastValue,e.diff);this.undoStack.push({diff:e.diff,selection:{...this.lastSelection}}),this._restoreState(t,e.selection)}_applyDiff(e,t){let n=``;return t.forEach(e=>{e.removed||(n+=e.value)}),n}_revertDiff(e,t){let n=``;return t.forEach(e=>{e.added||(n+=e.value)}),n}_restoreState(e,t){this.textarea.value=e,this.textarea.setSelectionRange(t.selectionStart,t.selectionEnd),this.lastValue=e,this.lastSelection={...t},this.editor.render&&this.editor.render(),this.textarea.focus()}},Ct=class{constructor(e,t){this.editor=e,this.textarea=e.usertextarea,this.renderCallback=t,this.pairs={"{":`}`,"[":`]`,"(":`)`,"<":`>`,'"':`"`,"'":`'`},this.init()}init(){this.textarea.addEventListener(`keydown`,e=>{switch(e.key){case`Tab`:e.preventDefault(),e.shiftKey?this.outdent():this.indent(),this._triggerUpdate();break;case`Enter`:this.autoIndent(e);break;case`Backspace`:this.handleBackspace(e);break;default:this.pairs[e.key]&&this.handlePairs(e)}})}handlePairs(e){let{textarea:t}=this,{selectionStart:n,selectionEnd:r,value:i}=t,a=e.key;if(n===r&&i[n]===a&&Object.values(this.pairs).includes(a)){e.preventDefault();let r=n+1;t.setSelectionRange(r,r);return}let o=a,s=this.pairs[o];if(s)if(n!==r){e.preventDefault();let a=i.substring(n,r);t.value=i.substring(0,n)+o+a+s+i.substring(r),t.setSelectionRange(n+1,r+1),this._triggerUpdate()}else{e.preventDefault();let a=i.substring(0,n),c=i.substring(r);t.value=a+o+s+c,t.setSelectionRange(n+1,n+1),this._triggerUpdate()}}handleBackspace(e){let{textarea:t}=this,{selectionStart:n,selectionEnd:r,value:i}=t;if(n===r&&n>0){let r=i[n-1],a=i[n];this.pairs[r]===a&&(e.preventDefault(),t.value=i.substring(0,n-1)+i.substring(n+1),t.setSelectionRange(n-1,n-1),this._triggerUpdate())}}autoIndent(e){let{textarea:t}=this,{selectionStart:n,value:r}=t,i=r.lastIndexOf(`
`,n-1),a=r.substring(i+1,n);if(/^(\s*)([\-\*] |\d+\. )/.test(a))return;let o=(a.match(/^[ \t]*/)||[``])[0],s=r[n-1],c=r[n];if(s===`{`&&c===`}`){e.preventDefault();let i=`
`+o+`	
`+o;t.value=r.substring(0,n)+i+r.substring(n);let a=n+o.length+1+1;t.setSelectionRange(a,a),this._triggerUpdate();return}if(o.length>0){e.preventDefault();let i=`
`+o;t.value=r.substring(0,n)+i+r.substring(t.selectionEnd);let a=n+i.length;t.setSelectionRange(a,a),this._triggerUpdate()}}_triggerUpdate(){typeof this.renderCallback==`function`&&this.renderCallback(),this.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}indent(){let{textarea:e}=this,{selectionStart:t,selectionEnd:n,value:r}=e,i=r.lastIndexOf(`
`,t-1)+1,a=r.indexOf(`
`,n);a===-1&&(a=r.length);let o=r.substring(i,a).split(`
`),s=o.map(e=>`	`+e).join(`
`);this._applyChange(r.substring(0,i)+s+r.substring(a),t+1,n+o.length)}outdent(){let{textarea:e}=this,{selectionStart:t,selectionEnd:n,value:r}=e,i=r.lastIndexOf(`
`,t-1)+1,a=r.indexOf(`
`,n);a===-1&&(a=r.length);let o=r.substring(i,a).split(`
`),s=0,c=0,l=o.map((e,t)=>e.startsWith(`	`)?(t===0&&(s=1),c++,e.substring(1)):e.startsWith(`    `)?(t===0&&(s=4),c+=4,e.substring(4)):e).join(`
`);this._applyChange(r.substring(0,i)+l+r.substring(a),Math.max(i,t-s),Math.max(i,n-c))}_applyChange(e,t,n){this.textarea.value=e,this.textarea.setSelectionRange(t,n)}},wt=class{constructor(e){this.editor=e,this.textarea=e.usertextarea,this.textarea.addEventListener(`keydown`,e=>{e.key===`Enter`&&this.handleEnter(e)})}handleEnter(e){let{selectionStart:t,value:n}=this.textarea,r=n.lastIndexOf(`
`,t-1)+1,i=n.substring(r,t),a=i.match(/^(\s*)(\d+)\.\s/),o=i.match(/^(\s*)([\-\*] )\[[\s xX]\] /),s=i.match(/^(\s*)([\-\*] )\s*/);if(i.match(/^(\s*)(\d+\.\s|[\-\*] \[[\s xX]\] |[\-\*]\s)$/)){e.preventDefault();let i=n.substring(0,r),a=n.substring(t);this.textarea.value=i+`
`+a,this.textarea.setSelectionRange(r+1,r+1),this.editor.render();return}let c=null;if(a?c=`${a[1]}${parseInt(a[2])+1}. `:o?c=`${o[1]}${o[2]}[ ] `:s&&(c=`${s[1]}${s[2]}`),c){e.preventDefault();let r=`\n${c}`,i=n.substring(0,t),a=n.substring(t);this.textarea.value=i+r+a;let o=t+r.length;this.textarea.setSelectionRange(o,o),this.editor.render()}}};return V.setOptions({breaks:!0}),class{constructor(e,t={}){this.usertextarea=typeof e==`string`?document.querySelector(e):e,this.options=t,this.mode=t.mode||`plain`,this.preview=this.options.toolbar?this.options.toolbar.includes(`preview`):!0,this.footerOptions=this._parseFooterOptions(t.footer),this.previewTimer=null,this.init(),this.undoRedoManager=new St(this),this.listManager=new wt(this),this.indentManager=new Ct(this)}_parseFooterOptions(e){if(e===!1)return null;let t=e??{};return{line:t.line!==!1,col:t.col!==!1,chars:t.chars!==!1}}init(){this.createEditor(),this.addToolbar(),this.addFooter()}createEditor(){this.isTextareaValid()&&(this.applyDefaultAttributes(),this.buildEditorLayout(),this.addInputListener(),this.render())}isTextareaValid(){return this.usertextarea.tagName===`TEXTAREA`}applyDefaultAttributes(){this.usertextarea.id&&document.querySelector(`label[for="${this.usertextarea.id}"]`)||this.usertextarea.getAttribute(`aria-label`)||this.usertextarea.getAttribute(`aria-labelledby`)||this.usertextarea.setAttribute(`aria-label`,this.options.label||`Markdown editor`),this.usertextarea.classList.add(`textarea`,`fj:focus:ring-0`,`fj:focus:outline-0`,`fj:border-0`,`fj:border-base-soft`,`fj:px-4`,`fj:py-2`,`fj:max-w-full`,`fj:size-full`,`fj:bg-transparent`,`fj:outline-0`,`fj:appearance-none`,`fj:overflow-y-auto`),this.usertextarea.hasAttribute(`placeholder`)||(this.usertextarea.placeholder=this.options.placeholder||`Write your markdown...`)}buildEditorLayout(){this.editorContainer=document.createElement(`div`),this.editorContainer.className=`
            markdown-editor-wrapper
            fj:me-surface
            fj:me-surface-outline
            fj:me-surface-rounded
            fj:overflow-hidden
        `,this.usertextarea.parentNode.insertBefore(this.editorContainer,this.usertextarea),this.markdownEditorDiv=document.createElement(`div`),this.markdownEditorDiv.className=`editor-layout fj:relative fj:grid fj:grid-cols-1`,this.editorContainer.appendChild(this.markdownEditorDiv),this.addTextareaWrapper(),this.preview&&this.addPreviewWrapper()}addTextareaWrapper(){let e=document.createElement(`div`);e.className=`
            textarea-wrapper
            not-prose
            fj:me-surface
            fj:h-full
        ...
        `,this.mode==`hybrid`&&(this.displayLayer=document.createElement(`div`),this.displayLayer.setAttribute(`data-placeholder`,this.usertextarea.placeholder),this.displayLayer.setAttribute(`aria-hidden`,!0),this.displayLayer.className=`
            ...
            `,this.usertextarea.className+=`
                ...
                fj:relative
                fj:z-10 
            `,e.appendChild(this.displayLayer)),e.appendChild(this.usertextarea),this.markdownEditorDiv.appendChild(e)}addPreviewWrapper(){let e=new ut(this.markdownEditorDiv);this.previewContent=e.getPreviewContent()}addInputListener(){this.usertextarea.addEventListener(`input`,()=>{this.renderHybrid(),this.debouncedPreview()}),this.usertextarea.addEventListener(`scroll`,()=>{if(this.mode===`hybrid`&&(this.displayLayer.scrollTop=this.usertextarea.scrollTop,this.displayLayer.scrollLeft=this.usertextarea.scrollLeft),this.preview&&this.previewContent){let e=this.usertextarea,t=e.scrollTop/(e.scrollHeight-e.clientHeight);this.previewContent.scrollTop=t*(this.previewContent.scrollHeight-this.previewContent.clientHeight)}})}debouncedPreview(){this.preview&&(clearTimeout(this.previewTimer),this.previewTimer=setTimeout(()=>{this.previewContent.innerHTML=V(this.usertextarea.value),this.wirePreviewCheckboxes()},150))}wirePreviewCheckboxes(){this.previewContent.querySelectorAll(`input[type="checkbox"]`).forEach((e,t)=>{e.removeAttribute(`disabled`),e.addEventListener(`click`,n=>{n.preventDefault();let r=this.usertextarea.value.split(`
`),i=0;for(let n=0;n<r.length;n++)if(/^(\s*)([-*] \[[ xX]\] )/.test(r[n])){if(i===t){e.checked?r[n]=r[n].replace(/\[ \]/,`[x]`):r[n]=r[n].replace(/\[[xX]\]/,`[ ]`);break}i++}this.usertextarea.value=r.join(`
`),this.render()})})}addFooter(){if(!this.footerOptions)return;let{line:e,col:t,chars:n}=this.footerOptions;if(!e&&!t&&!n)return;this.footer=new dt(this.editorContainer,this.footerOptions),this.footer.update(this.usertextarea);let r=()=>this.footer.update(this.usertextarea);this.usertextarea.addEventListener(`input`,r),this.usertextarea.addEventListener(`click`,r),this.usertextarea.addEventListener(`keyup`,r),this.usertextarea.addEventListener(`focus`,r)}addToolbar(){new lt(this,this.options.toolbar||[`undo`,`redo`,`heading`,`blockquote`,`ul`,`ol`,`checklist`,`outdent`,`indent`,`bold`,`italic`,`strikethrough`,`code`,`codeblock`,`hr`,`table`,`link`,`image`,`preview`])}insertText(e,t=0,n=0){let{selectionStart:r,selectionEnd:i}=this.usertextarea,a=this.usertextarea.value;this.usertextarea.value=`${a.substring(0,r)}${e}${a.substring(i)}`,this.usertextarea.focus(),this.usertextarea.setSelectionRange(r+t,r+e.length-n),this.scrollToView(),this.render()}scrollToView(){let e=this.usertextarea,t=e.selectionStart;this._lineHeight||=parseInt(window.getComputedStyle(e).lineHeight);let n=this._lineHeight,r=Math.floor(e.clientHeight/n);e.scrollTop=(Math.floor(t/e.cols)-Math.floor(r/2))*n}renderHybrid(){if(this.mode!==`hybrid`)return;let e=this.usertextarea.value,t=e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`);t=t.replace(/```(\w+)?\n([\s\S]*?)```/g,'<span class="fj:opacity-30">```$1</span>\n$2<span class="fj:opacity-30">```</span>').replace(/`([^`\n]+)`/g,'<span class="fj:opacity-40">`</span><span class="fj:text-accent">$1</span><span class="fj:opacity-40">`</span>').replace(/^(#+ )(.*)$/gm,`<span class="fj:text-primary"><span class="fj:opacity-40">$1</span><span class="fj:font-bold fj:tracking-[-0.040em]">$2</span></span>`).replace(/\*\*(.*?)\*\*/g,`<span class="fj:text-secondary"><span class="fj:opacity-40">**</span><span class="fj:font-bold fj:tracking-[-0.040em]">$1</span><span class="fj:opacity-40">**</span></span>`).replace(/^([\s]*)([\-\*] |[\d]+\. |\[[\s xX]\] )(.*)$/gm,`$1<span class="fj:text-primary fj:font-medium">$2</span>$3`).replace(/(\*|_)(.*?)\1/g,`<span class="fj:text-accent"><span class="fj:opacity-40">$1</span><span class="fj:italic">$2</span><span class="fj:opacity-40">$1</span></span>`).replace(/~~(.*?)~~/g,`<span class="fj:line-through fj:opacity-70"><span class="fj:opacity-40">~~</span>$1<span class="fj:opacity-40">~~</span></span>`).replace(/(?<!~)(~)([^~]+)\1(?!~)/g,`<span class="fj:line-through fj:opacity-70"><span class="fj:opacity-40">$1</span>$2<span class="fj:opacity-40">$1</span></span>`).replace(/(!?\[)(.*?)(\]\()(.*?)(\))/g,`<span class="fj:opacity-40">$1</span><span class="fj:text-primary">$2</span><span class="fj:opacity-40">$3</span><span class="fj:underline fj:opacity-50">$4</span><span class="fj:opacity-50">$5</span>`),e.length>0&&e.endsWith(`
`)&&(t+=` `),this.displayLayer.innerHTML=t}render(){this.renderHybrid(),this.preview&&(this.previewContent.innerHTML=V(this.usertextarea.value),this.wirePreviewCheckboxes())}}});
//# sourceMappingURL=markdown-text-editor.umd.js.map